...
const bustApprovalCache = invalidateCacheOnSuccess(['/approvals', '/expenses', 'expenses|', 'expenses:page:', 'imprest|', '/farmers', '/plots', '/cashflow', '/daybook', '/firms', '/registries', 'land-deals|', '/land-deals', 'misc-income|']);
