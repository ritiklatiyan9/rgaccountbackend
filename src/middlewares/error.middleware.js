const errorMiddleware = (err, req, res, next) => {
  ...
  const statusCode = (['project_unit_profile', 'plot_money_transfer_protected', 'transaction_transfer_protected'].includes(err.constraint) ? 409 : 0) || Number(err.statusCode)
