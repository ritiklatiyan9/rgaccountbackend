...
class ExpenseModel extends MasterModel {
  ...
  async findPaginatedUnified(siteId, filters, page = 1, limit = 20, pool) {
    ...
    const unifiedCTE = `
      WITH unified AS (
        SELECT 
          ...
          status, cheque_status, cheque_status_updated_at, approved_by, approved_at, created_by, created_at, updated_at,
        ...
        SELECT 
          ...
          fp.status, fp.cheque_status, fp.cheque_status_updated_at, fp.approved_by, fp.approved_at, fp.created_by, fp.created_at, fp.updated_at,
        ...
        SELECT 
          ...
          pcp.status, pcp.cheque_status, pcp.cheque_status_updated_at, pcp.approved_by, pcp.approved_at, pcp.created_by, pcp.created_at, pcp.updated_at,
        ...
        SELECT 
          ...
          vp.status, vp.cheque_status, vp.cheque_status_updated_at, vp.approved_by, vp.approved_at, vp.created_by, vp.created_at, vp.updated_at,
        ...
        SELECT 
          ...
          cfe.status, cfe.cheque_status, cfe.cheque_status_updated_at, cfe.approved_by, cfe.approved_at, cfe.created_by, cfe.created_at, cfe.updated_at,
        ...
        SELECT 
          ...
          d.status, d.cheque_status, d.cheque_status_updated_at, d.approved_by, d.approved_at, d.created_by, d.created_at, d.updated_at,
    ...
    // ── Q3: Summary aggregates (exclude rejected and fully returned records) ──
